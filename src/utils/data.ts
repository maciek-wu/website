...
const skillsData: Skill[] = [
  ...
  {
    name: "AI Agents",
    url: "https://github.com/resources/articles/what-are-ai-agents",
    progress: 50,
    category: "ai",
  },
  {
...
const projectsData: Project[] = [
  ...
  },
  {
    name: "Board App",
    description:
      "Enhanced fully customizable Chrome start page with advanced search features, shortcuts, todo list, notifications and many other features",
    tags: [
      "React",
      "TypeScript",
      "Service Worker",
    ...
    imageUrl: "projects/project-boardapp.webp",
    url: "https://board.coredata.pl",
  },
  {
    name: "WorkflowGPT",
    description:
...
const timelineItemsData: TimelineItemData[] = [
  ...
  },
  {
    ...
    description:
      "At Coredata, I work on interesting and unique projects. I leverage AI technologies to accelerate task execution and optimize workflow. I deal with consulting and customer service in the field of IT solutions. I design and implement web applications using the latest technologies. I create tools for automating business processes using data-driven ML technology.",
    skills: filter(
      [
